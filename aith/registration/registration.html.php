        ...
        <section id="registration">
            <form method="post" action=" ">
                ...
                <fieldset>
                    ...
                    <select size="1" name="saturdayrole" id="saturdayrole">
                    ...
                    <select size="1" name="saturdayevent" id="saturdayevent">
                    ...
                    <select size="1" name="sundayrole" id="sundayrole">
                        <option>Select Your Role</option>
                        <option value="none">None</option>
                        <option value="athlete">Athlete</option>
                        <option value="volunteer">Volunteer</option>
                    ...
                    <select size="1" name="sundayevent" id="sundayevent">
                        <option>Select Your Event</option>
                        <option value="none">None</option>
